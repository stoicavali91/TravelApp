  ...
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite backgroundImage="bg-bg-img-1" title="Kiwi1 Camp" subtitle="Sinaia, Cota1400" peopleJoined="50+ joined"/>
        <CampSite backgroundImage="bg-bg-img-2" title="Kiwi2 Camp" subtitle="Sinaia, Cota2000" peopleJoined="50+ joined"/>
      </div>
