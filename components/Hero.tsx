    ...
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        <Image 
          ...
          />
          <h1 className="bold-52 lg:bold-88">Kiwi Camp Area</h1>
          ...
          <div className="my-11 flex flex-wrap gap-5">
            ...
            <p className="bold-16 lg:bold-20 text-blue-70">198k <span className="regular-16 lg:regular-20 ml-1">Excelent Reviews</span> </p>
          </div>
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          ...
          <p className="bold-20 text-white">Sinaia</p>

          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular block text-gray-20">Distance</p>
              <p className="bold-20 text-white">140 km</p>
            </div>
            <div className="flex flex-col">
              <p className="regular block text-gray-20">Elevation</p>
              <p className="bold-20 text-white">1400 m</p>
            </div>
          </div>
